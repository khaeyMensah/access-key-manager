...
class User(AbstractUser):
    ...
    def is_profile_complete(self):
        """
        Checks if the user's profile is complete, i.e., they have a first name, last name, email, and either are an admin or a school personnel with a school affiliation.
